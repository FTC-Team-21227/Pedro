...
import org.firstinspires.ftc.teamcode.subsystems.Subsystem_Constants;
import org.firstinspires.ftc.teamcode.subsystems.TunePID;


@TeleOp(name = "Teleop_Pedro", group = "opmodes")
public class Teleop_Pedro extends PedroOpMode {
    public Teleop_Pedro(){
        super(ARM1.INSTANCE, ARM2.INSTANCE, CLAW.INSTANCE, CLAW_ANGLE.INSTANCE, INTAKE_ANGLE.INSTANCE, SWEEPER.INSTANCE);
    }
    ...
    public void onInit() {
        ...
        gamepadManager.getGamepad1().getLeftStick().setProfileCurve(Float -> Float*Float*Float);
    }

    /** This method is called once at the start of the OpMode. **/
    @Override
    public void onStartButtonPressed() {
        driverControlled = new DriverControlled(gamepadManager.getGamepad1(),false);
        driverControlled.invoke();
        
        follower.updatePose();
        gamepadManager.getGamepad2().getA().setPressedCommand( //change to hang positions, add hook up
            () -> new ParallelGroup(
        ...
        gamepadManager.getGamepad1().getDpadUp().setReleasedCommand( //change to hang down position, add arm2 up after time and hook down
                () -> new ParallelGroup(
                        ARM1.INSTANCE.toFloor()
                )
        );

        gamepadManager.getGamepad1().getX().setPressedCommand( //add servo commands
                () -> new SequentialGroup(
                        ARM1.INSTANCE.toHighRung2(),
                        ARM2.INSTANCE.toHighRung2()
                )
        );
...
//    private final double highBasket1 = Subsystem_Constants.highBasket1*ticks_in_degree_1;
//    private final double highRung1 = Subsystem_Constants.highRung1*ticks_in_degree_1;
//    private final double highRung1_2 = Subsystem_Constants.highRung1_2*ticks_in_degree_1;
//    private final double wall1 = Subsystem_Constants.wall1*ticks_in_degree_1;
//    private final double wall1_2 = Subsystem_Constants.wall1_2*ticks_in_degree_1;
//    private final double lowBasket1 = Subsystem_Constants.lowBasket1*ticks_in_degree_1;
//    private final double floor1 = Subsystem_Constants.floor1*ticks_in_degree_1;
//    private final double down1 = Subsystem_Constants.down1*ticks_in_degree_1;
//    private final double sub1 = Subsystem_Constants.sub1*ticks_in_degree_1;
...
//
//    private final double highBasket2 = Subsystem_Constants.highBasket2_teleop*ticks_in_degree_2;
...
//            telemetry.addData("No!","No!");
//        }
//        initialHeading = Math.toDegrees(initialPose.getHeading());
...
//        controller1 = new PIDFController(p1, i1, d1, new ArmFeedforward(f1,ticks_in_degree_1 -> 1.0));
//        controller2 = new PIDFController(p2, i2, d2, new ArmFeedforward(f2,ticks_in_degree_2 -> 1.0));
//
