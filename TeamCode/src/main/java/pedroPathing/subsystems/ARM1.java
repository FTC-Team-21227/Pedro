...
public class ARM1 extends Subsystem {
    ...
    public PIDFController controller = new PIDFController(p1, i1, d1, new ArmFeedforward(f1,ticks_in_degree_1 -> 1.0));
    public PIDFController controller2 = new PIDFController(p1, i1, d1, new ArmFeedforward(f1,ticks_in_degree_1 -> 1.0));
